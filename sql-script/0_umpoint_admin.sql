...
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1837080968620412929,1831997659548782594,'Update','','space:booking-rule:update',1,'',1,1067246875800000001,'2024-09-20 18:46:49',1067246875800000001,'2024-09-20 18:46:49');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1837081074476257282,1831999182806749185,'Update','','service:booking-rule:update',1,'',1,1067246875800000001,'2024-09-20 18:47:14',1067246875800000001,'2024-09-20 18:47:19');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1837082445111889922,1831999760773451777,'Update',NULL,'accommodation:booking-rule:update',1,NULL,1,1067246875800000001,'2024-09-20 18:52:41',1067246875800000001,'2024-09-20 18:52:41');
