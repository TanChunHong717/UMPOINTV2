...
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1067246875800000007,1067246875800000002,'Role','sys/role',NULL,0,'icon-team',3,1067246875800000001,'2024-07-26 23:17:12',1067246875800000001,'2024-12-07 17:08:27');
...
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1067246875800000012,1067246875800000002,'Department','sys/dept',NULL,0,'icon-apartment',4,1067246875800000001,'2024-07-26 23:17:12',1067246875800000001,'2024-12-07 17:08:35');
...
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1067246875800000055,1067246875800000002,'Admin','sys/user',NULL,0,'icon-user',2,1067246875800000001,'2024-07-26 23:17:12',1067246875800000001,'2024-12-07 17:08:40');
...
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1819637394333249538,1819639044389208066,'Tag','space/tag',NULL,0,'icon-tags',5,1067246875800000001,'2024-08-03 07:35:01',1067246875800000001,'2024-11-02 22:50:40');
...
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1821875193665142785,1819639044389208066,'Category','space/category','',0,'icon-appstore',4,1067246875800000001,'2024-08-09 19:44:30',1067246875800000001,'2024-11-02 22:50:36');
...
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1836060935270211585,1852724817376059393,'Add',NULL,'space:closure:save',1,NULL,1,1067246875800000001,'2024-09-17 23:13:34',1067246875800000001,'2024-11-02 22:51:27');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1836061001364054017,1852724817376059393,'Update',NULL,'space:closure:update',1,NULL,2,1067246875800000001,'2024-09-17 23:13:50',1067246875800000001,'2024-11-02 22:51:33');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1836061122441027586,1852724817376059393,'Delete',NULL,'space:closure:delete',1,NULL,3,1067246875800000001,'2024-09-17 23:14:19',1067246875800000001,'2024-11-02 22:51:38');
...
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1844665261014228993,1832790568795758594,'Refund','','payment:space:refund',1,'',2,1067246875800000001,'2024-10-11 17:04:05',1067246875800000001,'2024-10-11 17:04:05');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1844665325249994754,1832792281791455233,'Refund','','payment:service:refund',1,'',2,1067246875800000001,'2024-10-11 17:04:20',1067246875800000001,'2024-10-11 17:04:20');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1844665415440113666,1832792573014564865,'Refund','','payment:accommodation:refund',1,'',2,1067246875800000001,'2024-10-11 17:04:42',1067246875800000001,'2024-10-11 17:04:42');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1852675878060859393,1819639044389208066,'Dept Booking Rule','space/dept-booking-rule','',0,'icon-apartment',2,1067246875800000001,'2024-11-02 19:35:25',1067246875800000001,'2024-11-02 22:50:26');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1852676201970180097,1852675878060859393,'View','','space:dept-booking-rule:page,space:dept-booking-rule:info',1,'',0,1067246875800000001,'2024-11-02 19:36:42',1067246875800000001,'2024-11-02 19:36:42');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1852676667248517121,1852675878060859393,'Add','','space:dept-booking-rule:save',1,'',1,1067246875800000001,'2024-11-02 19:38:33',1067246875800000001,'2024-11-02 19:38:37');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1852676740921466881,1852675878060859393,'Update','','space:dept-booking-rule:update',1,'',1,1067246875800000001,'2024-11-02 19:38:51',1067246875800000001,'2024-11-02 19:38:51');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1852724817376059393,1819639044389208066,'Closure','space/closure','',0,'icon-lock',3,1067246875800000001,'2024-11-02 22:49:53',1067246875800000001,'2024-11-02 22:49:53');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1852725311389573122,1852724817376059393,'View',NULL,'space:closure:page',1,NULL,0,1067246875800000001,'2024-11-02 22:51:51',1067246875800000001,'2024-11-02 22:51:51');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1865322985817141249,1067246875800000002,'Report','chat/chat-user-report','',0,'icon-alert',1,1067246875800000001,'2024-12-07 17:10:31',1067246875800000001,'2024-12-07 17:11:29');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1865323214050193409,1865322985817141249,'View','','chat:report:page',1,'',0,1067246875800000001,'2024-12-07 17:11:25',1067246875800000001,'2024-12-07 17:11:25');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1865327592287006721,1865322985817141249,'Resolve','','chat:report:update',1,'',0,1067246875800000001,'2024-12-07 17:28:49',1067246875800000001,'2024-12-07 17:28:49');
INSERT INTO sys_menu (`id`,`pid`,`name`,`url`,`permissions`,`menu_type`,`icon`,`sort`,`creator`,`create_date`,`updater`,`update_date`) VALUES (1865655975294275585,0,'Chat','','chat:room:page,chat:room:info,chat:room:getroom,chat:room:update,chat:room:assignAdmin,chat:message:view',1,'',8,1067246875800000001,'2024-12-08 15:13:41',1067246875800000001,'2024-12-08 15:14:26');
