...
import my.edu.um.umpoint.modules.service.excel.SvcCategoryExcel;
...
public class SvcCategoryController {
    ...
    @LogOperation("Export")
    @RequiresPermissions("service:category:export")
    public void export(@Parameter(hidden = true) @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SvcCategoryDTO> list = svcCategoryService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, "Service Category", list, SvcCategoryExcel.class);
    }
