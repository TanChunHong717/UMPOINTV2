...
public class SvcBookingController {
    ...
    @Parameters({
        ...
        @Parameter(name = Constant.STATUS, description = "Booking status", in = ParameterIn.QUERY, schema = @Schema(type = "integer")) ,
        @Parameter(name = Constant.SERVICE, description = "Service name", in = ParameterIn.QUERY, schema = @Schema(type = "string"))
    })
