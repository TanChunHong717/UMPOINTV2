<template>
  <el-dialog v-model="visible" title="Approve Accommodation Booking" :close-on-click-modal="false" :close-on-press-escape="false">
...
const dataFormSubmitHandle = () => {
  dataFormRef.value.validate((valid: boolean) => {
    ...
    baseService.put("/accommodation/booking/approve/" + approveId.value, dataForm.value.technician).then((res) => {
      ElMessage.success({
        message: 'Success',
        duration: 500,
        onClose: () => {
