...
const dataForm = reactive({
  id: '',  name: '',  catId: '',  deptId: '',  address: '',  description: '',  facilities: '',  capacity: '',  manager: '',  bookingRuleId: '',  creator: '',  createDate: '',  updater: '',  updateDate: ''});
...
const dataFormSubmitHandle = () => {
  dataFormRef.value.validate((valid: boolean) => {
    ...
    (!dataForm.id ? baseService.post : baseService.put)("/service/service", dataForm).then((res) => {
      ElMessage.success({
        message: 'Success',
        duration: 500,
        onClose: () => {
